    ...
    return (
        <div className='bg-gray-100 dark:bg-gray-900'>
            <div className='flex justify-between text-xl items-center p-4 mt-2'>
                ...
                <div className='text-3xl text-red-600 font-bold dark:text-red-400'>{formatPrice(price, 'VND')}</div>
            </div>
            <div className='flex border-t border-gray-300 dark:border-gray-700 py-4'>
                <div className='w-1/2'>
                    <h2 className='text-red-600 text-2xl font-semibold dark:text-red-400'>{t('description')}</h2>
